package hum.open_message.tester;

import hum.open_message.KeyValue;
import hum.open_message.Message;
import hum.open_message.Producer;
import hum.open_message.constant.Constants;
...
public class ProducerTester {
    ...
    static class ProducerTask extends Thread {
        ...
        public void init() {
            try {
                Class kvClass = Class.forName("hum.open_message.core.DefaultKeyValue");
                KeyValue keyValue = (KeyValue) kvClass.getConstructor().newInstance();
                keyValue.put("STORE_PATH", Constants.STORE_PATH);
                Class producerClass = Class.forName("hum.open_message.core.DefaultProducer");
